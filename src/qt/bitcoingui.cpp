...
//	connect(statisticsAction, SIGNAL(triggered()), this, SLOT(gotoStatisticsPage()));
    ...
    aboutCardAction = new QAction(tr("Teslacoin Website"), this);
    aboutCardAction->setToolTip(tr("Go to Teslacoin website"));
//	tutoStackAction = new QAction(tr("How to stake"), this);
//	tutoStackAction->setToolTip(tr("Learn how POS works"));
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Teslacoin"), this);
    aboutAction->setToolTip(tr("Show information about Teslacoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for teslacoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("teslacoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("teslacoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to teslacoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid teslacoin address or malformed URI parameters."));
    }
